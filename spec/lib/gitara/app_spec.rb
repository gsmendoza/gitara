...
describe App do
  describe "export" do
    it "can convert a tab without a reused bar to lilypond" do
      app = Gitara::App.new
      app.invoke :export, ['examples/tab-with-bar.rb'], "target-directory" => test_tmp_dir.path, "run-lilypond" => false
    ...
    it "can convert a tab with a reused bar to lilypond" do
      app = Gitara::App.new
      app.invoke :export, ['examples/tab-with-reused-bar.rb'], "target-directory" => test_tmp_dir.path, "run-lilypond" => false
